...
Used Visual Studio Code to write the program
Built with Python and Arcade
Import Random library (to be able to randomly place food)


# Useful Websites

* [About Arcade](https://api.arcade.academy/en/stable/)
* [Keyboard Events](https://api.arcade.academy/en/3.3.2/programming_guide/keyboard.html)
* [Python Arcade: Basic Concepts](https://www.youtube.com/watch?v=MulMdcddiog&list=PLP6KYkkXj-QbBP0He1Ot5wGgtPbR9hqxR)
* [Adding Score](https://api.arcade.academy/en/3.3.3/tutorials/platform_tutorial/step_10.html)
...
# Future Work
* Make it so food doesn't appear on the snake -- DONE
* Multi-player
* Single player vs AI computer player
* Moving Food - food moves as you come within a certain distance from it
